   ...
   <div class="columns six logo"><a href="./index.php"><img src="./css/img/logo.png" alt="Lorena Piazze" /></a></div>
    ...
    <nav class="columns fifteen menu myMenu">
        <ul class="navegation">
            ...
            <li class="rootVoice active {menu: 'menu_4'}"><span class="navcurrent_left"></span><a href="community.php">Community Empowerment</a><span class="navcurrent_right"></span></li>
  ...
  <!-- end menus -->
       ...
       <div class="bg-menu">
        <nav class="primary clearfix container">
				<div class="titol title_blog display"><span class="slim"> Community Empowerment</span> </div>
		</nav>  
       </div>
      ...
      <section class="container content">
		...
		<div class="blog clearfix" style="padding-top:0;"> 
        		...
        		<div class="lista column twelve columns"> 
                        ...
                        <article>
                            <div class="title"><a href="">Instituciones</a></div>
            ...
            <?php 
              ...
              $sql=mysqli_query("SELECT  * FROM ".$lang."_instituciones  ORDER BY id DESC  ");
              if(mysql_num_rows($sql) != 0){ ?>
                          ...
                          <?php while ($row=mysql_fetch_assoc($sql)) { 
                            ...
                            if(!empty($row["email"])){
                              ...
                              echo '<li><a href="mailto:'.$row["email"].'">'.$row["nombre"].'</a></li>';

                            }elseif(!empty($row["link"])){

                              echo '<li><a href="'.$row["link"].'" target="_blank">'.$row["nombre"].'</a></li>';
                            }
				...
				<aside class="sidebar four columns">
                    ...
                    <article>
                        ...
                        <div class="bottomline2"></div>
                         <ul>
                         	<li ><a class"active" href="community.php">Instituciones</a></li>
                            <li class="sp_puntos"></li>
                            <li ><a  href="capacitacion.php">Capacitación</a></li>
                            <li class="sp_puntos"></li>
                            <li><a href="reddemujeres.php">Red de Mujeres Empresarias</a></li>
                            <li class="sp_puntos"></li>
