   ...
   <div class="columns six logo"><a href="./index.php"><img src="./css/img/logo.png" alt="Lorena Piazze" /></a></div>
    ...
    <nav class="columns fifteen menu myMenu">
        <ul class="navegation">
            ...
            <li class="rootVoice  active {menu: 'menu_3'}"><span class="navcurrent_left"></span><a href="vocesvitales.php">Voces Vitales</a><span class="navcurrent_right"></span></li>
  ...
  <!-- end menus -->
       ...
       <div class="bg-menu">
        <nav class="primary clearfix container">
				<div class="titol title_blog display"><span class="slim"> <a href="actividades.php" >Actividades</a></span>/ Mentoreo</div>
		</nav>  
       </div>
      ...
      <section class="container content">
        <div class="about home elements" style="padding-top:10px;">     
                                    ...
                                    <div class="ch-info-wrap">
                                        <div class="ch-info">
                                            ...
                                            <div class="ch-info-back">
                                                <h3>MENTOREO</h3>
                                                <p>
                                                <a href="mentoreo.php">+ más info</a></p>
                                            </div>   
                                        </div>
                                    </div>
                                </div> 
                            ...
                            <div class="ch-item ch-img-2">               
                                    <div class="ch-info-wrap">
                                        <div class="ch-info">
                                            ...
                                            <div class="ch-info-back">
                                                <h3>RED DE MUJERES EMPRESARIAS<br><br></h3><br><br>
                                                <p>
                                                <a href="red.php">+ más info</a></p>
                                            </div>   
                                        </div>
                                    </div>
                                </div> 
                            ...
                            <div class="ch-item ch-img-2">               
                                    <div class="ch-info-wrap">
                                        <div class="ch-info">
                                            ...
                                            <div class="ch-info-back">
                                                <h3>JORNADA DE REFLEXIÓN</h3><br>
                                                <p>
                                                <a href="jornada.php">+ más info</a></p>
                                            </div>   
                                        </div>
                                    </div>
                                </div> 
                            ...
                            <div class="ch-item ch-img-2">               
                                    <div class="ch-info-wrap">
                                        <div class="ch-info">
                                            ...
                                            <div class="ch-info-back">
                                                <h3>DERECHOS HUMANOS</h3><br>
                                                <p>
                                                <a href="derechoshumanos.php">+ más info</a></p>
                                            </div>   
                                        </div>
                                    </div>
                                </div> 
						...
						<div class="section">
                        	...
                        	<div class="image">
                               <div class="flexslider4">
                                    <ul class="slides">
                                        <li><img src="./css/img/about02.jpg" alt="img" /></li>
                                        <li><img src="./css/img/about01.jpg" alt="img" /></li>
                                        <li><img src="./css/img/about03.jpg" alt="img" /></li>
                                    </ul>
                               </div>
                            </div>
 
                        	<div class="text">
                            	El Mentoreo busca unir a líderes emergentes (aprendices) con líderes establecidas (mentoras) de amplia trayectoria, con el fin de capacitarlas mediante una experiencia de vida real, ampliar su red de contactos y reforzar la confianza en sí mismas, para lograr así llevar sus carreras y/o negocios al siguiente nivel.

<br>Experiencias locales e internacionales muestran que la relación mentora-aprendiz genera espacios nuevos, creativos, en donde las posibilidades de crecimiento para ambas partes se vuelven ilimitadas.

<br>Bajo esta modalidad, cada año se realizan dos programas: el <strong>“Programa de Mentoreo con Mujeres Líderes” </strong>y la <strong>“Caminata de Mentoreo”(Mentoring Walk)</strong>.
                            </div>
                        </div>

					<div class="clearfix" style="margin-bottom:17px;"></div>
</article>
</div>
...
<div class="cols">     
				...
				<article>
                	<div class="title column sixteen columns">Programa de Mentoreo con Mujeres Líderes</div>
                	<div class="column eight columns">El programa consiste en un acompañamiento durante una semana entre mentora y aprendiz con el propósito de compartir y aprender de su estilo de liderazgo y proceso de toma de decisiones. Para ello, la mentora podrá organizar:

<br>- Reuniones de Trabajo: para que la mentee observe por dentro la organización o empresa de la mentora, lo que le permite conocer y aprender sobre las diferentes áreas funcionales de relevancia para optimizar su proyecto existente.



</div>
                	<div class="column eight columns">- Reuniones de Networking (Redes): para que la mentee conozca los distintos ambientes en los que se desenvuelve su mentora, accediendo a contactos que puedan favorecerle en su proyecto personal.
                    <br>- Reuniones de Asesoría Proyecto de la aprendiz: para que la aprendiz reciba asesoría de su mentora para fortalecer su performance y potenciar el impacto del proyecto que lidera.<br>
                    El programa también prevé una sesión inicial introductoria de todo el grupo de mentoras y aprendices, capacitaciones y una jornada de cierre, donde se compartirán las experiencias de toda la semana y se evaluará el programa.</div>
                </article>

				<div class="clearfix"></div><div class="bottomline2"></div>

				<article>
                	<div class="title column sixteen columns">Caminata de Mentoreo (“Mentoring Walk”)</div>
                	<div class="column eight columns">La Caminata anual de Mentoreo “Mentoring Walk” se realiza simultáneamente en distintos países de la red de Vital Voices Global Partnership.

<br>Invita a mujeres mentoras y a aprendices a caminar juntas en su comunidad. Mientras caminan, se involucran en la discusión sobre sus éxitos profesionales y desafíos para establecer una relación de tutoría en que la mentora comparte su experiencia de vida profesional, aconseja y apoya a su aprendiz.

</div>
               	  <div class="column eight columns">El programa busca promover relaciones duraderas de tutoría entre aprendices y mentoras a fin de:

- Demostrar la importancia del liderazgo de las mujeres y su participación en la sociedad.<br>
- Inculcar el valor del mentoreo en las líderes emergentes para poder transmitirlo a generaciones futuras.<br>
- Proveer a las mentees la orientación que necesitan para poder llegar a cumplir sus objetivos.<br>
<a href="https://www.youtube.com/watch?v=TFM_6yZ6lg0&list=PLysgcRkRMRsFKnUmzUlWjI2yJVs0LxFUi" target="_blank">¡Conocé de qué se trata la Caminata de Mentoreo mirando estos videos!</a></div>
                </article>
				...
				<div class="clearfix"></div><div style="padding-bottom:20px;"></div>
		</div>
