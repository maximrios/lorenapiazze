...
<header class="clearfix">
    ...
    <nav class="columns fifteen menu myMenu">
        <ul class="navegation">
            ...
            <li class="rootVoice "><span class="navcurrent_left"></span><a href="agenda.php">Agenda</a><span class="navcurrent_right"></span></li>
              <li class="rootVoice  active "><span class="navcurrent_left"></span><a href="galeria2.php">Galeria</a><span class="navcurrent_right"></span></li>
        ...
        <select class="navegation_resp">
            ...
            <option value="./biografia.php" class="main_item" />Lorena Piazze
	            <option value="./biografia.php" class="second_item" />Biograf?a
	            <option value="./vision.php" class="second_item" />Visi?n
            ...
            <option value="./galeria.php" class="second_item" />Galer?a
            ...
            <option value="./noticiasvoces.php" class="second_item" />Noticias
                ...
                <option value="./capacitacion.php" class="second_item" />Capacitaci?n
 ...
 <div id="menu_2" class="mbmenu">
  ...
  <div id="menu_4" class="mbmenu">
    ...
    <a class="separator"> </a>
    <a href="capacitacion.php" class="{}">Capacitaci?n</a>
    <a class="separator"> </a>
  ...
  <!-- end menus -->
       ...
       <div class="bg-menu">
        <nav class="primary clearfix container">
				<div class="titol title_blog display"><span class="slim"> Galeria</span> de Fotos y Videos</div>
		</nav>  
       </div>
      ...
      <section class="container content">
		...
		<div class="portfolio cuadri">
            ...
            <?php 
              ...
              $sql=mysqli_query("SELECT  * FROM ".$lang."_galeria GROUP BY id  ORDER BY id DESC LIMIT 8 ");
              if(mysql_num_rows($sql) != 0){ ?>


            <?php while ($row=mysql_fetch_assoc($sql)) { 

              $query = mysqli_query("SELECT  * FROM ".$lang."_galeria_imagenes   WHERE idr = ".$row["id"]." ORDER BY id DESC LIMIT 1 ");
              if (mysql_num_rows($query) != 0) {  $raw=mysql_fetch_assoc($query); $class=(!empty($row["video"])) ? "fancyv" : "fancy"; ?>
        ...
        <article class="columns four ">
                  ...
                  <div class="posicio4col ">
                     ...
                     <div class="imagen">
                    <div class="hover"><a class="<?=$class?>" title="<?=$row["nombre"]?>" href="<?php if(!empty($row["video"])) { echo 'http://www.youtube.com/embed/'.$row["video"].'?autoplay=1';} else { ?> ./img/<?php echo $raw["imagen"]; }?>"><div class="link"></div></a></div><img src="./img/<?=$raw["imagen"]?>" alt="img2" /></div>
