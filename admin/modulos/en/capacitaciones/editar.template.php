                <div class="box-info full">
                        ...
                        <div class="box-info">
                        <h2><strong>Editar capacitacion:</strong> <?=$row["nombre"]?></h2>
                        ...
                        <form data-toggle="validator" id="myForm" method="POST" action="" role="form">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text"  name="email" value="<?=$row["email"]; ?>" id="email" class="form-control text-input" >

                                </div>

                                <div class="form-group">
                                    <label for="dni">Link</label>
                                    <input type="text"  name="link" value="<?=$row["link"]; ?>" id="link" class="form-control text-input"  >
