                    ...
                    if (!$enviado) { ?>
                        ...
                        <div class="box-info">
                        <h2 class="text-center">Solicite Presupuesto</h2>
                            ...
                            <form role="form" action="" method="POST">
                                ...
                                <div class="form-group login-input">
                                <i class="fa fa-sign-in overlay"></i>
                                <textarea name="mensaje" class="form-control text-input"><?php if(isset($_POST["mensaje"])) echo $_POST["mensaje"]; ?></textarea>
                                </div>

                                <button type="submit" class="btn btn-success btn-block"><i class="fa fa-rocket"></i> Solicitar</button>
