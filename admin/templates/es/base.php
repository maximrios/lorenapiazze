                ...
                <div class="sidebar-inner ">            
                    ...
                    <div id="sidebar-menu">
                        <ul>
                                ...
                                <li '; if($sec == "index" ) echo 'class="active"'; echo'><a href="'.$conf["url"].'"><i class="fa fa-home"></i> Inicio</a></li>
                                <li '; if($sec == "noticias" ) echo 'class="active"'; echo'><a href="#"><i class="fa fa-table"></i><i class="fa fa-angle-double-down i-right"></i> Noticias</a>
                                    <ul>
                                        <li><a href="'.$conf["url"].'?sec=noticias&subsec=agregar"><i class="fa fa-angle-right"></i> Nueva noticia</a></li>
                                        <li><a href="'.$conf["url"].'?sec=noticias"><i class="fa fa-angle-right"></i> Lista de noticias </a></li>
                                    </ul>
                                </li>
                                <li '; if($sec == "contacto" ) echo 'class="active"'; echo'><a href="'.$conf["url"].'?sec=contacto"><i class="fa fa-envelope"></i>Form contacto</a></li>    
                                <li '; if($sec == "instituciones" ) echo 'class="active"'; echo'><a href="#"><i class="fa fa-table"></i><i class="fa fa-angle-double-down i-right"></i> Instituciones</a>
                                    <ul>
                                        <li><a href="'.$conf["url"].'?sec=instituciones&subsec=agregar"><i class="fa fa-angle-right"></i> Nueva institucion</a></li>
                                        <li><a href="'.$conf["url"].'?sec=instituciones"><i class="fa fa-angle-right"></i> Lista de instituciones </a></li>
                                    </ul>
                                </li>

                                <li '; if($sec == "capacitaciones" ) echo 'class="active"'; echo'><a href="#"><i class="fa fa-table"></i><i class="fa fa-angle-double-down i-right"></i> Capacitaciones</a>
                                    <ul>
                                        <li><a href="'.$conf["url"].'?sec=capacitaciones&subsec=agregar"><i class="fa fa-angle-right"></i> Nueva capacitacion</a></li>
                                        <li><a href="'.$conf["url"].'?sec=capacitaciones"><i class="fa fa-angle-right"></i> Lista de capacitaciones </a></li>
                                    </ul>
                                </li>

                                <li '; if($sec == "mujeres" ) echo 'class="active"'; echo'><a href="#"><i class="fa fa-table"></i><i class="fa fa-angle-double-down i-right"></i> Mujeres empresarias</a>
                                    <ul>
                                        <li><a href="'.$conf["url"].'?sec=mujeres&subsec=agregar"><i class="fa fa-angle-right"></i> Nueva</a></li>
                                        <li><a href="'.$conf["url"].'?sec=mujeres"><i class="fa fa-angle-right"></i> Listado </a></li>
                                    </ul>
                                </li>

                                <li '; if($sec == "galeria" ) echo 'class="active"'; echo'><a href="#"><i class="fa fa-table"></i><i class="fa fa-angle-double-down i-right"></i> Galerias</a>
                                    <ul>
                                        <li><a href="'.$conf["url"].'?sec=galeria&subsec=agregar"><i class="fa fa-angle-right"></i> Nueva</a></li>
                                        <li><a href="'.$conf["url"].'?sec=galeria"><i class="fa fa-angle-right"></i> Listado </a></li>
                                    </ul>
                                </li>

                                <li '; if($sec == "agenda" ) echo 'class="active"'; echo'><a href="#"><i class="fa fa-table"></i><i class="fa fa-angle-double-down i-right"></i> Agenda</a>
                                    <ul>
                                        <li><a href="'.$conf["url"].'?sec=agenda&subsec=agregar"><i class="fa fa-angle-right"></i> Nueva</a></li>
                                        <li><a href="'.$conf["url"].'?sec=agenda"><i class="fa fa-angle-right"></i> Listado </a></li>
                                    </ul>
                                </li>
                            ...
                            <ul class="nav navbar-nav navbar-right top-navbar">
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu animated half flipInX">
                                        <li><a href="'.$conf["url"].'?sec=configuracion">Configuración</a></li>
                                        <li class="divider"></li>

                                        <li><a class="md-trigger" href="'.$conf["url"].'?sec=salir">Salir</a></li>
                                    </ul>
                                </li>
...
function  template_footer() {   global  $conf, $sec;
 ...
 echo'<!-- Footer -->
    ...
    <script src="'.$conf['url'].'ckeditor/ckeditor.js"></script>
