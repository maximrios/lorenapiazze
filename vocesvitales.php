    ...
    <nav class="columns fifteen menu myMenu">
        ...
        <select class="navegation_resp">
            ...
            <option value="./noticiasvoces.php" class="second_item" />Noticias
                ...
                <option value="./instituciones.php" class="second_item" />Instituciones
  ...
  <!-- end menus -->
       ...
       <div class="bg-menu">
        <nav class="primary clearfix container">
				<div class="titol title_blog display"><span class="slim"> Voces Vitales</span> </div>
		</nav>  
       </div>
      ...
      <section class="container content">
		...
		<div class="blog clearfix" style="padding-top:0;"> 
        		...
        		<div class="lista column twelve columns"> 
                        ...
                        <article>
                            <div class="title"><a href="">A cerca de Voces</a></div>
                           <iframe width="560" height="315" src="//www.youtube.com/embed/HzjgCdPicZY" frameborder="0" allowfullscreen></iframe>
                            <!--<div class="marc"></div>-->
                            <div class="text">Voces Vitales Argentina es una fundación dedicada a promover el liderazgo de la mujer como motor para el progreso económico, político y social de toda la comunidad.

</div>
                            <div class="text">Al igual que su organización madre, Vital Voices Global Partnership cree esencialmente en el valor transformador de la participación de la mujer en la sociedad. Este enfoque se sustenta en estudios de organizaciones tales como el Banco Mundial y el B.I.D., que demuestran que la inversión en el desarrollo de la mujer es la medida más efectiva para reducir la pobreza y mejorar la salud y la educación, y con ello, elevar el bienestar general.</div>

 <div class="text">El capítulo local fue fundado por participantes argentinas de las iniciativas internacionales de Vital Vital Global Partnership, en particular del Fortune/State Department Global Leadership Mentoring Program. Inspiradas por sus experiencias y por el interés encontrado en las mujeres de nuestro país, iniciaron sus actividades en 2009 realizando acciones de mentoreo y capacitación que replican los programas globales de la organización.</div>

 <div class="text">El capítulo argentino cuenta con un equipo de trabajo en Buenos Aires y con una delegación en Córdoba, que implementan los programas de la organización en dichas provincias.</div>
				...
				<aside class="sidebar four columns">
                    ...
                    <article>
                        ...
                        <div class="bottomline2"></div>
                         <ul>
                         	<li ><a class"active" href="vocesvitales.php">A cerca de Voces</a></li>
                            <li class="sp_puntos"></li>
                            <li ><a  href="staff.php">Staff</a></li>
                            <li class="sp_puntos"></li>
                            <li><a href="actividades.php">Actividades</a></li>
                            <li class="sp_puntos"></li>
                            <li><a href="comoserparte.php">Cómo ser parte</a></li>
                            <li class="sp_puntos"></li>
                            <li><a href="noticiasvoces.php">Noticias</a></li>
                            <li class="sp_puntos"></li>
                        </ul>
                    </article>
