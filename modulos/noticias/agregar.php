<?php 
	...
	if (isset($_POST["enviado"]) && $_POST["enviado"] == $_SESSION["token"]) {
	  ...
	  mysqli_query("INSERT INTO `noticias` (`id`, `titulo`, `epigrafe`, `texto`, `fecha`, `categoria`) VALUES (NULL, '".$_POST["titulo"]."', '".$_POST["epigrafe"]."', '".$_POST["texto"]."', CURDATE(), '".$_POST["categoria"]."');");
