                <div class="box-info full">
                        ...
                        <div class="box-info">
                        <h2><strong>Agregar institucion</strong></h2>
                        ...
                        <form data-toggle="validator" id="myForm" method="POST" action="" role="form">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text"  name="email"  id="email" class="form-control text-input"  data-error="Campo requerido" required>
                                    <div class="help-block with-errors"></div>
                                </div>

                                <div class="form-group">
                                    <label for="dni">Link</label>
                                    <input type="text"  name="link" id="link" class="form-control text-input"  data-error="Campo requerido" required>
                                    <div class="help-block with-errors"></div>
                                </div>
