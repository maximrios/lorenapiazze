...
<header class="clearfix">
 ...
 <div id="menu_2" class="mbmenu">
  ...
  <!-- end menus -->
      ...
      <section class="container content">
		...
		<div class="blog clearfix" style="padding-top:0;"> 
        		...
        		<div class="lista column twelve columns"> 
                        ...
                        <article>
                            <div class="title"><a href="">Actividad Profesional</a></div>
                           	<div class="imagen"><div class="hover" style="display: none;"></div><img alt="img1" src="./css/img/actividad.jpg" /></div>
                            <!--<div class="marc"></div>-->
    ...
    <div class="about home elements" style="padding-top:0px;">     
                    ...
                    <div class="sect-left">
                        ...
                        <div class="faq">
                            <div class="item">
                            	<div class="question qopen"><div class="icon"></div>Directora Comercial de VIDPIA Vidrios Piaze,</div>
                                <div class="answer">la compañía de mayor trayectoria en el multiprocesado de Cristales para Arquitectura de Latinoamérica, empresa familiar con mas de 65 años en el mercado nacional, ya en su tercera generación Lorena, siendo una de las empresarias más reconocidas del país. Un ejemplo de fortaleza, estrategia y pasión por los resultados.</div>
                            </div>
                            <div class="item">
                            	<div class="question qclosed"><div class="icon"></div>Co-fundadora de Voces Vitales Argentina</div>
                                <div class="answer none">Lorena Piazze es una de las co-fundadoras de Voces Vitales Argentina y desde el año 2009, representa Voces Vitales Argentina Delegación Córdoba.</div>
                            </div>
                            <div class="item">
                            	<div class="question qclosed"><div class="icon"></div></div>
				...
				<aside class="sidebar four columns">
                    ...
                    <article>
                        ...
                        <li ><a  href="biografia.php">Biografía</a></li>
                            ...
                            <li class="sp_puntos"></li>
                            <li><a  class"active" href="actividadprofesional.php">Actividad Profesional</a></li>
                            <li class="sp_puntos"></li>
