...
if (!isset($_GET["fecha"])) {
  ...
  $sql=mysqli_query("SELECT  * FROM ".$lang."_agenda WHERE fecha LIKE '".$_GET["fecha"]."' ORDER BY fecha ASC");
...
<head>
 ...
 <title>Lorena Piazze</title>
  ...
  <link rel="stylesheet" href="./css/layout.css" type="text/css" media="screen" />
    <link rel="stylesheet" href="./css/responsive-calendar.css" type="text/css" media="screen" />
   ...
   <div class="columns six logo"><a href="./index.php"><img src="./css/img/logo.png" alt="Lorena Piazze" /></a></div>
    ...
    <nav class="columns fifteen menu myMenu">
        <ul class="navegation">
            ...
            <li class="rootVoice active"><span class="navcurrent_left"></span><a href="agenda.php">Agenda</a><span class="navcurrent_right"></span></li>
        ...
        <option value="./comoserparte.php" class="second_item" />Como ser parte
            <option value="./noticiasvoces.php" class="second_item" />Noticias
              <option value="./community.php" class="main_item" />Community Empowerment
                ...
                <option  selected="selected" value="./agenda.php" class="main_item" />Agenda
 ...
 <div id="menu_2" class="mbmenu">
  ...
  <!-- end menus -->
       ...
       <div class="bg-menu">
        ...
        <div class="titol title_blog display"><span class="slim"> Agenda</span> </div>
    </nav>  
       </div>
...
$sql=mysqli_query("SELECT  * FROM ".$lang."_agenda WHERE fecha LIKE '".$_GET["fecha"]."' ORDER BY fecha ASC ".$limit);
...
<aside class="sidebar four columns">
            ...
            <div class="titular" style="margin-left:12px;">
                            <h2>Agenda</h2>
                            <div class="sp_doble small"></div>
                        </div>
      ...
      $(document).ready(function () {
        $(".responsive-calendar").responsiveCalendar({
          ...
          <?php    
                  ...
                  $sql3=mysqli_query("SELECT  * FROM ".$lang."_agenda  ORDER BY id DESC LIMIT 5 ");
                  $total = mysql_num_rows($sql3);
                      if($total != 0){ 
                        $count=1;

                        while ($roww=mysql_fetch_assoc($sql3)) { 

                          if ($count == $total) {
                            echo '"'.$roww["fecha"].'": {"url": "ver_agenda.php?fecha='.$roww["fecha"].'"}';
                          }else{
                            echo '"'.$roww["fecha"].'": {"url": "ver_agenda.php?fecha='.$roww["fecha"].'"},';
                          }
