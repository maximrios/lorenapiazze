  ...
  <div id="menu_5" class="mbmenu">
      ...
      <section class="container content">
        		...
        		<div class="detalle column twelve columns"> 
                        ...
                        <article>
                            <div class="title"><a href="./noticia4.php">“Cada generación marcó un hito en la empresa”</a></div>
                            <div class="icons">
                            	
                                <span class="fecha">5 de Enero de 2014</span>
                                
                        </div>
                            <iframe width="560" height="315" src="//www.youtube.com/embed/924cVvlLkvE" frameborder="0" allowfullscreen></iframe>
                            
                            
                            <div class="text">Lorena Piazze, tercera generación al frente de vidrios Piazze, relata la evolución de esta empresa familiar con más de 60 años en el mercado local y cómo lograron replantear el negocio para pasar de ser distribuidores a fabricantes. </div>
                        <div class="text"></div>
                          <div class="text"><a href="http://www.buenosnegocios.com/notas/529-rcada-generacion-marco-un-hito-la-empresar" target="_blank">AUTOR: Equipo editorial de Buenos Negocios</a></div>
				...
				<aside class="sidebar four columns">
                  ...
                  <article>
                        ...
                        <div class="bottomline2"></div>
                        <ul>
                            <li><a href="noticia2.php">Vidpia lanzó su red para negocios y profesionales</a></li>
                            <li class="sp_puntos"></li>
                            <li><a href="noticia3.php">La promoción de hábitos saludables como causa</a></li>
                            <li class="sp_puntos"></li>
                            <li><a href="noticia4.php">“Cada generación marcó un hito en la empresa”</a></li>
                            <li class="sp_puntos"></li>
                            <li><a href="noticia5.php">VVA recibió el premio Fortune Global Women Leaders Award</a></li>
                            <li class="sp_puntos"></li>
