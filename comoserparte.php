...
<header class="clearfix">
      ...
      <section class="container content">
		...
		<div class="blog clearfix" style="padding-top:0;"> 
        		...
        		<div class="lista column twelve columns"> 
                        ...
                        <article>
                            <div class="title"><a href="">Como ser parte</a></div>
                           	 	<div class="imagen"><img alt="img1" src="./css/img/comoserparte.jpg" /></div>
                            <!--<div class="marc"></div>-->
                            <div class="text">Voces Vitales Argentina es una organización de la sociedad civil, apartidaria, y como tal financia sus actividades a través de donaciones de individuos y de aportes institucionales del sector privado y público tanto del ámbito local como internacional.
 ...
 <div class="text">Podés colaborar con Voces Vitales Argentina de distintos modos:<br>

* Como sponsor de alguno de los programas.
<br>* Participando de la Campaña “Sumemos Voces”
<br>* Como voluntaria

<br>Si estás interesada en apoyar el trabajo de Voces Vitales Argentina, escribinos a <a href="mailto:capituloargentina@vitalnetwork.org">capituloargentina@vitalnetwork.org</a></div>
				...
				<aside class="sidebar four columns">
                    ...
                    <article>
                        ...
                        <div class="bottomline2"></div>
                        <ul>
                         	<li ><a  href="vocesvitales.php">A cerca de Voces</a></li>
                            <li class="sp_puntos"></li>
                            <li ><a href="staff.php">Staff</a></li>
                            <li class="sp_puntos"></li>
                            <li><a href="actividades.php">Actividades</a></li>
                            <li class="sp_puntos"></li>
                            <li><a class"active" href="comoserparte.php">Cómo ser parte</a></li>
                            <li class="sp_puntos"></li>
