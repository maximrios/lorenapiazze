  ...
  <!-- end menus -->
       ...
       <div class="bg-menu">
        <nav class="primary clearfix container">
				<div class="titol title_blog display"><span class="slim"> <a href="actividades.php" >Actividades</a></span>/ Red de Mujeres Empresarias</div>
		</nav>  
       </div>
						...
						<div class="section">
                        	...
                        	<div class="image">
                               <div class="flexslider4">
                                    <ul class="slides">
                                        <li><img src="./css/img/red01.jpg" alt="img" /></li>
                        	...
                        	<div class="text">
                            	Es una <strong>plataforma mundial</strong> que apoya el empoderamiento económico de la mujer y conecta a propietarias de empresas y socios, 
                                a través de programas, capacitaciones y oportunidades de impacto. Actualmente, se encuentra activa en 8 países de Latinoamérica
                                 y el Caribe, y en 26 países alrededor del mundo.<br>
                            </div><br>
                            <div class="text">
                            	<strong>Beneficiarias</strong>
<br>Mujeres dueñas de PyMEs empresarias y emprendedoras interesadas en crecer, dar visibilidad y mejorar la eficiencia de sus empresas.
                            </div><br>
                            <div class="text">
                            	<strong>Objetivo general</strong>
<br>Promover el crecimiento de las empresas de las mujeres miembros, a través de un incremento en las ventas, 
cantidad de empleados, conexiones entre empresas, sistemas nuevos
 y más eficientes y desarrollo de la aptitud de liderazgo.
                            </div><br>
                            
                             <div class="text"><strong>Impacto deseado</strong>

   <br> Crecimiento de los negocios: Aprovechar las oportunidades para incrementar ventas y expandir las empresas de las mujeres miembros.
   <br> Habilidades empresariales y de liderazgo: Adquirir y mejorar habilidades de negocio y confianza accediendo a entrenamientos, capacitaciones y actividades.
   <br> Expandir la red de contactos: A través de nuevas oportunidades de networking.
   <br> Ganar visibilidad para vos y tu negocio: Gracias a las actividades que brindan visibilidad y exposición.
    Obtener importantes beneficios y descuentos: Posibilidad de ofrecer y recibir descuentos a miembros de la red. 
</div><br>
                             <div class="text"><strong>Actividades</strong>

   <br> * Workshops mensuales: siendo miembro podrás capacitarte en temas de relevancia para la gestión de tu PyME, trabajar tus capacidades de liderazgo y obtener herramientas para la mejor gestión y crecimiento de tu empresa.
  <br>  * Rondas de Negocios: donde dar visibilidad a tus productos y servicios, potenciar tus negocios e incrementar las ventas de tu empresa, encontrándote con potenciales clientes.
   <br> * Encuentros con CEOs: donde contactarte con otras mujeres, referentes del mundo corporativo, en un espacio para el crecimiento mutuo, compartir experiencias y generar contactos.
  <br>  * Programas de Mentoreo/Rondas de Negocios Internacionales: donde además de capacitarte y adquirir herramientas para el crecimiento de tu empresa, podrás contactarte con una red global de mujeres con similares intereses y necesidades, desafíos y objetivos.
  <br>  * Encuentros de Networking: para ampliar la red de contactos y generar nuevos negocios
  <br>  * Otras actividades de Voces Vitales Argentina
</div><br>
                              <div class="text"> <strong>¿Quiénes pueden participar?</strong>

<br>* Mujeres empresarias
<br>* Mujeres dueñas de PyMEs
<br>* Mujeres Emprendedoras

<br>Previa aprobación de la Red de Mujeres Empresarias de Latinoamérica y el Caribe.</div><br>
                               <div class="text"><strong>¿Dónde está activa la Red?</strong> </div>
 ...
 <article class="columns four web">
	                <div class="posicio4col">
				
                    <div class="imagen">
                    <div class="hover"><a class="fancy" href="./css/img/redmapa.jpg"><div class="link"></div></a></div><img src="./css/img/redmapachi.jpg" alt="img2" /></div>
