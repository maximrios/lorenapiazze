      ...
      <section class="container content">
		...
		<div class="blog clearfix" style="padding-top:0;"> 
        		...
        		<div class="lista column twelve columns"> 
                        ...
                        <article>
                            <div class="title"><a href="">Red de Mujeres Empresarias</a></div>
            ...
            <?php 
              ...
              $sql=mysqli_query("SELECT  * FROM ".$lang."_mujeres  ORDER BY id DESC  ");
              if(mysql_num_rows($sql) != 0){ ?>
                          ...
                          <?php while ($row=mysql_fetch_assoc($sql)) { ?>
                            ...
                            <li><?=$row["nombre"]?>, <a href="mailto:<?=$row["texto"]?>"><?=$row["texto"]?></a></li>
