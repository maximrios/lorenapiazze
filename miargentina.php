  ...
  <!-- end menus -->
       ...
       <div class="bg-menu">
        <nav class="primary clearfix container">
				<div class="titol title_blog display"><span class="slim"> A cerca de Lorena</span> </div>
		</nav>  
       </div>
      ...
      <section class="container content">
		...
		<div class="blog clearfix" style="padding-top:0;"> 
        		...
        		<div class="lista column twelve columns"> 
                        ...
                        <article>
                            <div class="title"><a href="">Mi Argentina</a></div>
                           	<div class="imagen"><div class="hover" style="display: none;"></div><img alt="img1" src="./css/img/argentina.jpg" /></div>
                            <!--<div class="marc"></div>-->
                            <div class="text">Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Aenean vitae porta neque. 
                            Aliquam sagittis nulla turpis, a posuere urna ultrices vitae. Ut justo ante, tempus a convallis eu, laoreet imperdiet lacus. Aliquam lobortis mi ac congue pretium. 
                            Vivamus risus tellus, egestas ut volutpat sit amet, tristique ut nulla. Suspendisse eget viverra eros. Praesent sollicitudin quam lorem, ut pulvinar lacus molestie non.
                            Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Aenean vitae porta neque. Aliquam sagittis nulla turpis, a posuere urna ultrices vitae. Ut justo ante, tempus a convallis eu, laoreet imperdiet lacus. Aliquam lobortis mi ac congue pretium.
                             Vivamus risus tellus, egestas ut volutpat sit amet, tristique ut nulla. Suspendisse eget viverra eros. Praesent sollicitudin quam lorem, ut pulvinar lacus molestie non.</div>
                            <div class="text">Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Aenean vitae porta neque. 
                            Aliquam sagittis nulla turpis, a posuere urna ultrices vitae. Ut justo ante, tempus a convallis eu, laoreet imperdiet lacus. Aliquam lobortis mi ac congue pretium. 
                            Vivamus risus tellus, egestas ut volutpat sit amet, tristique ut nulla. Suspendisse eget viverra eros. Praesent sollicitudin quam lorem, ut pulvinar lacus molestie non.
                            Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Aenean vitae porta neque. Aliquam sagittis nulla turpis, a posuere urna ultrices vitae. Ut justo ante, tempus a convallis eu, laoreet imperdiet lacus. Aliquam lobortis mi ac congue pretium.
				...
				<aside class="sidebar four columns">
                    ...
                    <article>
                        ...
                        <ul>
                            ...
                            <li ><a class"active" href="vision.php">Visión</a></li>
                            <li class="sp_puntos"></li>
                            <li><a href="distinciones.php">Distinciones</a></li>
                            <li class="sp_puntos"></li>
                            <li><a href="actividadprofesional.php">Actividad Profesional</a></li>
                            <li class="sp_puntos"></li>
                            <li><a href="miargentina.php">Mi Argentina</a></li>
                            <li class="sp_puntos"></li>
