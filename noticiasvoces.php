  ...
  <div id="menu_5" class="mbmenu">
       ...
       <div class="bg-menu">
        <nav class="primary clearfix container">
				<div class="titol title_blog display"><span class="slim"><a href="./noticias.php">Noticias de Voces Vitales</a></span></div>
		</nav>  
       </div>
      ...
      <section class="container content">
		...
		<div class="blog clearfix" style="padding-top:0;"> 
              ...
              $sql=mysqli_query("SELECT  ".$lang."_noticias.*, ".$lang."_noticias_imagenes.imagen FROM ".$lang."_noticias INNER JOIN ".$lang."_noticias_imagenes ON  ".$lang."_noticias_imagenes.idr =  ".$lang."_noticias.id WHERE ub2 = 1 GROUP  BY ".$lang."_noticias.id ORDER BY id DESC LIMIT 5 ");
              ...
              <?php while ($row=mysql_fetch_assoc($sql)) {     $row["fecha"] = date('d', strtotime($row["fecha"]))." de ".$meses[date('n', strtotime($row["fecha"]))-1]. " del ".date('Y', strtotime($row["fecha"]));  ?>
                        ...
                        <article>
                            ...
                            <div class="imagen"><div class="hover" style="display: none;"><a href="ver_noticia.php?id=<?=$row["id"]?>"><div class="link"></div></a></div><img alt="img1" src="img/<?=$row["imagen"]?>" /></div>
                            <!--<div class="marc"></div>-->
            ...
            <?php 
              ...
              $sql=mysqli_query("SELECT  * FROM ".$lang."_noticias  WHERE ub2 != 1  ORDER BY id DESC LIMIT 5  ");
              if(mysql_num_rows($sql) != 0){ ?>
