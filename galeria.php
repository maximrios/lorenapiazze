  ...
  <!-- end menus -->
       ...
       <div class="bg-menu">
        <nav class="primary clearfix container">
				<div class="titol title_blog display"><span class="slim"> Galería</span> </div>
		</nav>  
       </div>
		...
		<div class="portfolio cuadri">
				...
				<article class="columns four ">
                	...
                	<div class="posicio4col ">
                     ...
                     <div class="imagen">
                    <div class="hover"><a class="fancy" href="./css/img/01gr.jpg"><div class="link"></div></a></div><img src="./css/img/01.jpg" alt="img2" /></div>
				...
				<article class="columns four web">
                    ...
                    <div class="imagen">
                    <div class="hover"><a class="fancy" href="./css/img/02gr.jpg"><div class="link"></div></a></div><img src="./css/img/02.jpg" alt="img2" /></div>
                    <div class="bottomline"></div>   
				...
				<article class="columns four web">
                    ...
                    <div class="imagen">
                    <div class="hover"><a class="fancy" href="./css/img/03gr.jpg"><div class="link"></div></a></div><img src="./css/img/03.jpg" alt="img2" /></div>
...
<article class="columns four web">
                    ...
                    <div class="imagen">
                    <div class="hover"><a class="fancy" href="./css/img/04gr.jpg"><div class="link"></div></a></div><img src="./css/img/04.jpg" alt="img2" /></div>
                     <div class="bottomline"></div>   
  ...
  <article class="columns four web">
                    ...
                    <div class="imagen">
                    <div class="hover"><a class="fancy" href="./css/img/05gr.jpg"><div class="link"></div></a></div><img src="./css/img/05.jpg" alt="img2" /></div>
                ...
                <article class="columns four web">
                    ...
                    <div class="imagen">
                    <div class="hover"><a class="fancy" href="./css/img/06gr.jpg"><div class="link"></div></a></div><img src="./css/img/06.jpg" alt="img2" /></div>
                  ...
                  <article class="columns four web">
                    ...
                    <div class="imagen">
                    <div class="hover"><a class="fancy" href="./css/img/07gr.jpg"><div class="link"></div></a></div><img src="./css/img/07.jpg" alt="img2" /></div>
                  ...
                  <article class="columns four web">
                    ...
                    <div class="imagen">
                    <div class="hover"><a class="fancy" href="./css/img/08gr.jpg"><div class="link"></div></a></div><img src="./css/img/08.jpg" alt="img2" /></div>
