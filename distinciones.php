      ...
      <section class="container content">
		...
		<div class="blog clearfix" style="padding-top:0;"> 
        		...
        		<div class="lista column twelve columns"> 
                        ...
                        <article>
                            <div class="title"><a href="">Distinciones</a></div>
                           	<div class="imagen"><div class="hover" style="display: none;"></div><img alt="img1" src="./css/img/distinciones.jpg" /></div>
                            <!--<div class="marc"></div>-->
                            
                            <div class="text">Algunos de sus logros profesionales:</div>
                            
                            <div class="text">
                            <ul> 
                            
                            <li>Empresaria Destacada 2014 - Revista Pyme Clarín  </li>
                            <li>Empresaria Emprendedora 2013 - Fundacion E+E  </li>
                            <li>Historia de Éxito 2013 Banco Galicia - buenos negocios.com </li>
                            <li>Empresaria del año 2012 - Revista Punto a Punto </li>
                            <li>Empresaria Fortune 2008 - Gobierno de los Estados Unidad - Vital Voices Global </li>
                            <li>Caso de Éxito Exportador 2005 - Fundación Exportar</li>
                            <li>Joven Empresaria Destacada 2004 - Embajada de los Estados Unidos</li>
				...
				<aside class="sidebar four columns">
                    ...
                    <article>
                        ...
                        <ul>
                            ...
                            <li class="sp_puntos"></li>
                            <li><a class"active" href="distinciones.php">Distinciones</a></li>
                            <li class="sp_puntos"></li>
