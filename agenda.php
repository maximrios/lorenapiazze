...
$sql=mysqli_query("SELECT  * FROM ".$lang."_agenda WHERE fecha >= CURDATE()  ORDER BY fecha ASC ");
...
$sql=mysqli_query("SELECT  * FROM ".$lang."_agenda WHERE fecha >= CURDATE()  ORDER BY fecha ASC ".$limit);
